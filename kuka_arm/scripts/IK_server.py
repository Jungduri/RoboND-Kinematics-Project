      ...
      # Initialize service response
        ...
        for x in xrange(0, len(req.poses)):
            ...
            WC = EE - 0.303 * ROT_EE[: ,2]
             ...
             # get joint form 1 to 3
            theta1 = atan2(WC[1], WC[0])
                        # find the 3rd side of the triangle
            side_b = sqrt(pow((sqrt(WC[0]*WC[0] + WC[1]*WC[1]) - 0.35), 2) + pow((WC[2] - 0.75), 2))

            #Cosine Laws SSS to find all inner angles of the triangle
            angle_a = acos((-0.6875 + side_b*side_b) / (2.5*side_b))
            angle_b = acos(( 3.8125 - side_b*side_b) / (3.75))
            angle_c = acos(( 0.6875 + side_b*side_b) / (3.0*side_b))
            ...
            ## get joint theta form 4 to 6 (RRR)
